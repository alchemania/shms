                ...
                <el-form :model="registerform" label-width="120px">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="handleRegister"
                            :loading="registerIconLoading">Create</el-button>
            ...
            <template v-if="(registerStep == 1)">
                <el-form :model="registerform" label-width="200px">
                    ...
                    <el-form-item label="年龄">
                        <el-input v-model="extendInfoForm.age" clearable><template #append>岁</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="身高">
                        <el-input v-model="extendInfoForm.height" clearable><template #append>cm</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                    ...
                    <el-form-item label="体重">
                        <el-input v-model="extendInfoForm.weight" clearable><template #append>kg</template>
                        </el-input>
                    </el-form-item>
                    <el-form-item>
...
import { login, register, alterHealthData, getValidCode, validValidCode, redirectAdmin } from '../../api/api'
        ...
        .then((res) => {
            ...
            if (res.data.code === 200) {
                ...
                if (res.data.data.privilege == 1) {
                    window.location.href = "http://localhost:8089/authLogin"
                } else {
                    router.push({
                        path: "/main"
                    })
...
.loginbody {
    ...
    height: 100%;
    min-width: 1000px;
    background-image: "../../assets/login_background.jpg";
